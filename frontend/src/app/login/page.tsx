...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4">
            ...
            <div className="fixed top-1/4 left-1/4 w-96 h-96 bg-[#6C5CE7]/10 rounded-full blur-3xl" />
            <div className="fixed bottom-1/4 right-1/4 w-96 h-96 bg-[#00CEC9]/10 rounded-full blur-3xl" />
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-white/50 mt-1">Protect your voice from AI</p>
                </div>
                ...
                <div className="glass-panel p-8 rounded-2xl">
                    ...
                    <p className="text-center text-white/40 text-sm mt-6">
                        ...
                        <Link href="/signup" className="text-[#6C5CE7] hover:text-[#00CEC9] transition-colors font-medium">
                            Sign up
                        </Link>
                    </p>
                </div>
